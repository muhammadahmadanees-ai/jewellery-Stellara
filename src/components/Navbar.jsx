      ...
      <div className="container nav-container mobile-nav-layout">
        <div className="nav-logo-group">
          ...
          <Link
            ...
            className="logo nav-mobile-center"
          ...
          >
            ...
            <span
              className="logo-text"
              style={{ fontFamily: 'var(--font-serif)', fontWeight: 'bold', fontSize: '1.4rem', letterSpacing: '2px' }}
            >
        ...
        <nav>
          <ul className="nav-links pc-only-flex">
            <li>
              <Link href="/" id="nav-home-btn" onClick={handleHomeClick}>
                Home
              </Link>
            </li>
            <li>
              <Link href="/collections" id="nav-collections-btn" onClick={handleCollectionsClick}>
                Collections
              </Link>
            </li>
            <li>
